...
use App\Http\Requests\API\CreatetwitterAPIRequest;
use App\Http\Requests\API\UpdatetwitterAPIRequest;
use App\Models\twitter;
use App\Repositories\twitterRepository;
...
class twitterAPIController extends AppBaseController
{
  /**
     * @var string
     */
